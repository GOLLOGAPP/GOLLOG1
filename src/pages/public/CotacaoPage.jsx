          ...
          <div className="public-card" style={{ textAlign:'center' }}>
            ...
            <div style={{ background:'#F9FAFB', borderRadius:12, padding:24, textAlign:'left', marginTop:20 }}>
              <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:16 }}>
                <div>
                  <div style={{ fontSize:11, color:'#6B7280', marginBottom:2 }}>Origem</div>
                  <div style={{ fontSize:15, fontWeight:600, color:'#1A1A1A' }}>{result.origem}</div>
                </div>
                <div>
                  <div style={{ fontSize:11, color:'#6B7280', marginBottom:2 }}>Destino</div>
                  <div style={{ fontSize:15, fontWeight:600, color:'#1A1A1A' }}>{result.destino}</div>
                </div>
                <div>
                  <div style={{ fontSize:11, color:'#6B7280', marginBottom:2 }}>Peso</div>
                  <div style={{ fontSize:15, fontWeight:600, color:'#1A1A1A' }}>{result.peso} kg</div>
                </div>
                <div>
                  <div style={{ fontSize:11, color:'#6B7280', marginBottom:2 }}>Serviço</div>
                  <div style={{ fontSize:15, fontWeight:600, color:'#1A1A1A' }}>GOLLOG {result.servico}</div>
                </div>
              </div>
        ...
        <div className="public-card">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ background:'#F9FAFB', borderRadius:8, padding:16, marginBottom:20 }}>
              ...
              <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:12 }}>
                <div className="form-group" style={{ marginBottom:0 }}>
                  <label className="form-label" style={{ color:'#374151' }}>CEP Origem *</label>
                  <input className="public-input" required placeholder="00000-000"
                    value={form.cep_origem} onChange={e => handleChange('cep_origem', e.target.value)} />
                </div>
                <div className="form-group" style={{ marginBottom:0 }}>
                  <label className="form-label" style={{ color:'#374151' }}>Cidade Origem</label>
                  <input className="public-input" placeholder="São Paulo/SP"
                    value={form.cidade_origem} onChange={e => handleChange('cidade_origem', e.target.value)} />
                </div>
                <div className="form-group" style={{ marginBottom:0 }}>
                  <label className="form-label" style={{ color:'#374151' }}>CEP Destino *</label>
                  <input className="public-input" required placeholder="00000-000"
                    value={form.cep_destino} onChange={e => handleChange('cep_destino', e.target.value)} />
                </div>
                <div className="form-group" style={{ marginBottom:0 }}>
                  <label className="form-label" style={{ color:'#374151' }}>Cidade Destino</label>
                  <input className="public-input" placeholder="Curitiba/PR"
                    value={form.cidade_destino} onChange={e => handleChange('cidade_destino', e.target.value)} />
                </div>
              </div>
            </div>
              ...
              <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr 1fr', gap:8 }}>
                {[
                  ...
                  <button key={s.val} type="button"
                    ...
                    onClick={() => handleChange('tipo_servico', s.val)}
                    style={{ padding:12 }}>
            ...
            <div className="form-group">
              ...
              <select className="public-input" value={form.unidade}
