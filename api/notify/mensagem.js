import { sendWhatsApp, nomeValidoBC, getConfig, clearConfigCache, sendEmail, emailTemplate } from '../_lib/notify.js';
...
export default async function handler(req, res) {
  ...
  // Mode 1: Follow-Up Test Runner (merged from former api/test/followup)
  if (req.body?.tipo) {
    const {
      tipo,
      phone = '',
  ...
  // Mode 2: Standard WhatsApp message dispatch
  try {
